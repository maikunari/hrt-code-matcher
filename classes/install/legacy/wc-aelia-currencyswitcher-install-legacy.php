 ...
 *
 * NOTE
 * This class has been preserved temporarily, for reference. It's no longer used.
 *
 * @deprecated 5.0.4.230626
 */
class WC_Aelia_CurrencySwitcher_Install_Legacy extends \Aelia\WC\Aelia_Install {
	 ...
	 * @since 5.0.4.230626
	 */
	protected function update_to_5_0_4_230626() {
		$price_decimals = WC_Aelia_CurrencySwitcher::settings()->price_decimals($this->settings->base_currency());
